            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                        <input type="number" id='bedrooms' max="10000" min="1" className='p-3 border border-gray-300 rounded-lg' required onChange={handleChange} value={formData.bedrooms}/>
                        <p>Beds</p>
                    </div>
                    <div className='flex items-center gap-2'>
                    ...
                    {formData.offer && (
                        <div className='flex items-center gap-2'>
                        <input type="number" id='discountPrice' max="1000000" min="50" className='p-3 border border-gray-300 rounded-lg' required onChange={handleChange} value={formData.discountPrice} />
                        <div className='flex flex-col items-center'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <p className="text-red-700 text-sm">{imageUploadError && imageUploadError}</p>
                {
                    formData.imageUrls.length > 0 && formData.imageUrls.map((url , index)=>{
                        return <div key={index} className="flex justify-between p-3 border border-gray-200 items-center rounded-lg">
                ...
                <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-90'>{loading ? "Creating" : "Create Listing"}</button>
